  ...
  return (
    <WhyWrapper>
      <div className="why-content">
        ...
        <p>
          We Are Introducing A New Paradigm In The Decentralized Finance Space.
        </p>
        <Primary>
      ...
      <div className="why-cards">
        ...
        <div className="card">
          ...
          <p>
            3swap Aims To Be Financially Conducive And/Or Appealing By Allowing
            You To Pay Less For Swaps Executed.
          </p>
          <img src={CardArrowIcon} alt="" className="card-arrow" />
        </div>
        <div className="card">
          ...
          <p>
            3swap Aims To Offer More Value For The Provision Of Liquidity Across
            Three Tokens.
          </p>
          <img src={CardArrowIcon} alt="" className="card-arrow" />
        </div>
